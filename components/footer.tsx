        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Your AI-powered shoe shopping destination. Find the perfect pair with our smart recommendations.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/recommendations" className="text-gray-600 hover:text-gray-900 text-sm">
                  AI Recommendations
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600 text-sm">Email: info@shopwise.com</li>
              <li className="text-gray-600 text-sm">Phone: (123) 456-7890</li>
              <li className="text-gray-600 text-sm">Address: 123 Shoe St, Fashion City</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">© {new Date().getFullYear()} ShopWise. All rights reserved.</p>
